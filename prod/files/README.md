...
The 'getting_started_ab' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] getting_started_ab_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/getting_started_ab.job.yml). The schedule
